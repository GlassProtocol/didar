...
type Document struct {
	...
	Reference      *Reference  `protobuf:"bytes,100,opt,name=reference,proto3" json:"reference,omitempty"`
}
...
func (x *Document) GetReference() *Reference {
	if x != nil {
		return x.Reference
	}
	return nil
...
var file_document_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xc5, 0x01, 0x0a, 0x08, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x32, 0x0f, 0x2e, 0x64, 0x69, 0x64, 0x61, 0x72, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x2e, 0x0a, 0x09, 0x72,
	0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x64, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10,
	0x2e, 0x64, 0x69, 0x64, 0x61, 0x72, 0x2e, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65,
	0x52, 0x09, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x09, 0x5a, 0x07, 0x2f,
...
var file_document_proto_goTypes = []interface{}{
	...
	(*Key)(nil),       // 1: didar.key
	(*Metadata)(nil),  // 2: didar.metadata
	(*Reference)(nil), // 3: didar.reference
}
var file_document_proto_depIdxs = []int32{
	1, // 0: didar.document.authentication:type_name -> didar.key
	2, // 1: didar.document.metadata:type_name -> didar.metadata
	3, // 2: didar.document.reference:type_name -> didar.reference
