...
func (x *Metadata) GetProfile() *Profile {
	if x, ok := x.GetData().(*Metadata_Profile); ok {
		return x.Profile
	}
	return nil
}
...
type Metadata_Profile struct {
	Profile *Profile `protobuf:"bytes,2,opt,name=profile,proto3,oneof"`
}

func (*Metadata_Profile) isMetadata_Data() {}
...
var file_metadata_proto_rawDesc = []byte{
	...
	0x12, 0x05, 0x64, 0x69, 0x64, 0x61, 0x72, 0x1a, 0x0d, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3e, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x12, 0x2a, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x64, 0x69, 0x64, 0x61, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x66,
	0x69, 0x6c, 0x65, 0x48, 0x00, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x42, 0x06,
	0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x3b, 0x64, 0x69, 0x64, 0x61,
...
var file_metadata_proto_goTypes = []interface{}{
	(*Metadata)(nil), // 0: didar.metadata
	(*Profile)(nil),  // 1: didar.profile
}
var file_metadata_proto_depIdxs = []int32{
	1, // 0: didar.metadata.profile:type_name -> didar.profile
